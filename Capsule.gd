...
func _on_area_2d_body_entered(body):
	if body.name == "Marsh":
		...
		tween.tween_property($"../Audio/OceanPalace", "volume_db",-80, 2)
		capsule.play("opening")
		$"../Audio/ActComplete".play()
		body.stopmovement(30)
		...
		tween.set_ease(Tween.EASE_OUT)
		tween.set_trans(Tween.TRANS_LINEAR)
		tween.tween_property($"../Audio/OceanPalace", "volume_db",-80, 5)
		await get_tree().create_timer(7).timeout 
		get_tree().change_scene_to_file("res://ttza1cutscene.tscn")
